 ...
 */
#define LM3643_FLASH_BRT_MIN	11310
#define LM3643_FLASH_BRT_STEP	11720
 ...
 */
#define LM3643_TORCH_BRT_MIN 1060
#define LM3643_TORCH_BRT_STEP 1460
#define LM3643_TORCH_BRT_MAX 187000
 ...
 */
#define LM3643_FLASH_TOUT_MIN		10
#define LM3643_FLASH_TOUT_LOW_STEP	10
#define LM3643_FLASH_TOUT_LOW_MAX	100
#define LM3643_FLASH_TOUT_HIGH_STEP	50
#define LM3643_FLASH_TOUT_MAX		400
#define LM3643_FLASH_TOUT_ms_TO_REG(a)	\
	((a) < LM3643_FLASH_TOUT_MIN ? 0 :	\
	 ((a) <= LM3643_FLASH_TOUT_LOW_MAX ?	\
	  (((a) - LM3643_FLASH_TOUT_MIN) / LM3643_FLASH_TOUT_LOW_STEP) :	\
	   ((((a) - LM3643_FLASH_TOUT_LOW_MAX) / LM3643_FLASH_TOUT_HIGH_STEP)	\
		+((LM3643_FLASH_TOUT_LOW_MAX - LM3643_FLASH_TOUT_MIN)	\
		/ LM3643_FLASH_TOUT_LOW_STEP))))
